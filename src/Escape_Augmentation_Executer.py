...
import DataAnalyzer
FEATURE_LEARNING_MODEL_PATH = "model/escape_gan/feature_learning"
#m2 best model
FEATURE_LEARNING_FULL_MODEL_PATH = "model/escape_gan/archives/m4/feature_learning/checkpoints/bilstm/bilstm_256-01.hdf5"
DISCRIMINATOR_LEARNING_MODEL_PATH = "model/escape_gan/archives/m4/disc_learning"
...
BASE_ANALYSIS_PATH = "/home/perm/cov/model/escape_gan/archives/m4/results"  #"data/analysis/escape_gan"
...
def train_embedding_model(seqs, epochs=1):
    ...
    batch_train(model, seqs, batch_size=64, n_epochs=epochs) #Batch size: 32
...
def get_features_gan(windowed_file):
    model =load_fz_model()
...
def execute_discriminator_network():
...
def save_embedded_features(seq_path, save_features_path):
    ...
    '''
    embed_feautres = get_features_gan(seq_path)    
...
if __name__ == "__main__":
    ...
    # train_embedding_model(embed_seqs, epochs=1)
