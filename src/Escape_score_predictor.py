...
import DataAnalyzer
# FEATURE_LEARNING_FULL_MODEL_PATH = "/home/perm/cov/model/pretrain_models/feature_learning_model/bilstm_256-04.hdf5"
#FEATURE_LEARNING_FULL_MODEL_PATH= "/home/perm/cov/model/escape_gan/archives/m4/feature_learning/checkpoints/bilstm/bilstm_256-01.hdf5"
# FEATURE_LEARNING_FULL_MODEL_PATH= "/home/perm/cov/model/escape_gan/archives/m2/feature_learning/checkpoints/bilstm/bilstm_256-01.hdf5"
FEATURE_LEARNING_FULL_MODEL_PATH= "/home/perm/sars_escape_netv2/model/feature_learning/bilstm_256-08.hdf5"
#DISCRIMINATOR_LEARNING_MODEL_PATH = "/home/perm/cov/model/pretrain_models/discriminator-model/integrated_model"
#DISCRIMINATOR_LEARNING_MODEL_PATH = "/home/perm/cov/model/escape_gan/archives/m4/disc_learning" #Auc : 74
# DISCRIMINATOR_LEARNING_MODEL_PATH = "/home/perm/cov/model/escape_gan/archives/m2/disc_learning" #Auc : 77
DISCRIMINATOR_LEARNING_MODEL_PATH = "/home/perm/sars_escape_netv2/data/model_results_archive/m17/sarsx_disc" #Auc : 77
...
BASE_ANALYSIS_PATH = "data/analysis/escape_gan"

GAN_AUG_SEQS_FILE = "data/gen/escape_gan_seqs/non_sat_orig/filter_sequences__feature_learning_network_8000.csv"
...
def featurize_seqs(seqs):
        ...
        return X, lens
def batch_train(model, seqs,  batch_size=8,  n_epochs=1):
    # Control epochs here.
...
def train_embedding_model(seqs, epochs=1):
    ...
    batch_train(model, seqs, batch_size=8, n_epochs=epochs) #Batch size: 32
...
def get_model_structure(seq_len=23, vocab_size=27):
    #inference_batch_size=24
        ...
        model = BiLSTMLanguageModel(
            ...
            cache_dir=FEATURE_LEARNING_FULL_MODEL_PATH,
            seed=41,
            verbose=True,
        )
...
def load_fz_model():
    ...
    model.model_.load_weights(FEATURE_LEARNING_FULL_MODEL_PATH)
    return model
...
def get_balanced_datasets_over_sampling(non_sig_train, non_sig_test, sig_train_orig, sig_test):
    BATCH_SIZE = 8
    SHUFFLE_BUFFER_SIZE = 64 #40166 #366,533 + 40166
...
def execute_aggregate_network():
    ...
    sig_train_escape_aug = get_features("data/additional_escape_variants/gen/significant_combined_windows_train_gan_generated.csv")
...
def save_results_to_csv(target, predicted, save_path):
    ...
    print(f"Greaney Prediction Results saves successfully to path:{save_path} ")
...
def predict_escape_score(csv_path):
    print("Predicting Esapace score of given sequence")
    model = m.load_model(DISCRIMINATOR_LEARNING_MODEL_PATH)
    
    features, seqs = get_single_window_based_feature(csv_path)
    #Analyze  predictions | plot AUC_ROC / Confusion Matrix / Precision Recall
    y_preds = model.predict(features)
...
def predict_new_sequences(csv_file_path, score_save_path):
    ...
    print("Saving records to CSV path: ",score_save_path)
...
if __name__ == "__main__":
    ...
    aug_seqs = ASE.read_window_file(GAN_AUG_SEQS_FILE)
    
    total_seqs = seqs_train + aug_seqs
    random.shuffle(total_seqs)
    print("Total Seqs length", len(total_seqs))
    train_embedding_model(seqs_train, epochs=1)'''
    #execute_aggregate_network()
    #analyze_greany()
    # files  = ['4000.csv', '12000.csv', '16000.csv'] 
    # for file in files:
    #     predict_new_sequences(f"/home/perm/ProteinGAN/data/log_archive/non_sat_25m_dim_128/{file}", 
    #                       f'/home/perm/ProteinGAN/data/log_archive/non_sat_25m_dim_128/fasta_{file.split(".")[0]}_pred_score.csv')
